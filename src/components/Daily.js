...
const GetLoadandOperation = async () => {
    ...
    try {
      ...
      const data = await axios.get(
        "  http://18.192.109.219/ht/api/load-readings/?all_record=1", 
...
const selectOptions = {
  ...
  filter: selectFilter({
    ...
    {
      dataField: "date_for", text: "Date", sort: true,   filter: dateFilter()
    ...
    {
      dataField: 'operations.time_in', text: "Time In", sort: true
    },
    ,
    {
      dataField: 'operations.time_out', text: "Time Out", sort: true
              ...
              >
                {
                  props => (
                    <div>
                      ...
                      <h3 style={{ borderRadius: '0.25em', textAlign: 'center', color: 'blue', border: '10px solid blue', padding: '0.5em' }}>
                          ALL FEEDER DATA COLLECTION              </h3>
